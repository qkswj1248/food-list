...
public enum SecurityErrorCode implements ErrorCode{
    ...
    SECURITY_USER_NOT_FOUND(1000, "유저를 찾을 수 없습니다."),
    SECURITY_PASSWORD_IS_WRONG(1000, "패스워드가 틀립니다."),
    ACCESS_DENIED(404, "접근 금지"),

    CUSTOM_WRONG_TYPE_TOKEN(1001, "잘못된 타입의 토큰"),
    CUSTOM_EXPIRED_TOKEN(1002, "토큰이 만료됨"),
    CUSTOM_UNSUPPORTED_TOKEN(1003, "지원되지 않는 토큰"),
